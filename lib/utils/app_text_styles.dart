...
class AppTextStyles {
  ...
  static TextStyle regular20White60 = GoogleFonts.inter(
  ...
  static TextStyle regular15White = GoogleFonts.roboto(
    color: AppColors.white,
    fontSize: 15,
    fontWeight: FontWeight.w400,
  );
  ...
  static TextStyle regular16Grey = GoogleFonts.roboto(
    color: AppColors.grey,
    fontSize: 16,
    fontWeight: FontWeight.w400,
  );
  ...
  static TextStyle regular20LightGrey = GoogleFonts.roboto(
    color: AppColors.lightGrey,
    fontSize: 20,
    fontWeight: FontWeight.w400,
  );
  static TextStyle regular20Grey = GoogleFonts.roboto(
    color: AppColors.grey,
    fontSize: 20,
    fontWeight: FontWeight.w400,
  );
